...
>>>>>>> 6cb3531 (chore(quality): add pre-commit, Dependabot, update LICENSE/README, contributing docs)
=======
...
>>>>>>> bc9ee9b (chore(professionalize): add issue templates, CODEOWNERS, SECURITY, CHANGELOG, Makefile, README badges)
